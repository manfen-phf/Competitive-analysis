...
export default function Dashboard() {
  ...
  return <main className="insight-canvas management-page">
    <header className="management-heading"><div><p>价格洞察</p><h1>竞争定价分析</h1><span>仅基于已由 BD 确认的美团与 B 家订单数据计算。</span></div><Link className="primary compact" href="/collect">补充订单证据</Link></header>
